...
import { CHAINS, EVENTS, KEYRING_CATEGORY_MAP } from '@/constant';
...
import { getOriginFromUrl, Message } from '@/utils';
import rpcCache from './backgroundUtils/rpcCache';
import eventBus from '@/eventBus';
import migrateData from '@/migrations';
// import stats from '@/stats';
import createSubscription from './controller/provider/subscriptionManager';
import buildinProvider from './backgroundUtils/builtinProvider';
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc';
import { setPopupIcon } from './backgroundUtils';
...
async function restoreAppState() {
  ...
  keyringService.store.subscribe((value: any) =>
